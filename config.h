...
#define GNULIB_TEST_GETRANDOM 0
...
#define HAVE_CFPREFERENCESCOPYAPPVALUE 0
...
/* Define if localtime-like functions can loop forever on extreme arguments.
   */
#define HAVE_LOCALTIME_INFLOOP_BUG 1
...
#define HAVE_STRUCT_STAT_ST_ATIMESPEC_TV_NSEC 0
...
/* #undef  #define HAVE_STRUCT_STAT_ST_BIRTHTIMESPEC_TV_NSEC */
...
#define PACKAGE_STRING "GNU PSPP 1.4.1"
