...
class FactorAnalysisDialog extends React.Component {
    ...
    render() {
        const title = <div onClick={() => this.setState({ show: true})}>Factor Analysis</div>;
        if (!this.state.show) {
...
export default FactorAnalysisDialog;
